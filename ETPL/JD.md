# Senior DevOps Engineer (Munshify)
**Job ID:** ETPL-MN-3158  
...
- Containerize applications using Docker and support container deployments
- Implement infrastructure automation using Ansible and IaC practices
- Build and maintain high-availability systems (clustering, load balancing)
- Define and enforce infrastructure and network security standards
- Integrate DevOps tools (code review, testing, load testing frameworks)
- Monitor systems using observability and monitoring tools
...
- Ownership mindset for system reliability and delivery
